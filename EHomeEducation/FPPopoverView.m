...
#define FP_POPOVER_ARROW_HEIGHT 8.0
#define FP_POPOVER_ARROW_BASE 8.0
...
//    CGGradientRef gradient = CGGradientCreateWithColorComponents(colorSpace, colors, NULL, 2);
    ...
    // 创建起点颜色
    CGColorRef beginColor = CGColorCreate(colorSpaceRef, (CGFloat[]){192.0 / 256.0,233 / 256.0,189 / 256.0,0.8 });
    
    // 创建终点颜色
    CGColorRef endColor = CGColorCreate(colorSpaceRef, (CGFloat[]){192.0 / 256.0,233 / 256.0,189 / 256.0,0.8 });
...
- (void)drawRect:(CGRect)rect
{
    ...
    //content fill
    CGPathRef contentPath = [self createContentPathWithBorderWidth:5.0 arrowDirection:_arrowDirection];
    ...
    if(self.tint == FPPopoverBlackTint)
    {
        ...
        CGContextSetRGBFillColor(ctx, 192.0 / 256.0, 233 / 256.0, 189 / 256.0, 0.8 );
    }
    else if(self.tint == FPPopoverLightGrayTint)
    {
